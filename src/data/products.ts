...
// AI-generated product images stored locally in /public/products/
export const products: Product[] = [
  {
    ...
    image: '/products/cotton-candy-cloud.jpg',
    tintColor: '#C4B5FD',
  ...
  },
  {
    ...
    image: '/products/midnight-galaxy.jpg',
    tintColor: '#6D28D9',
  ...
  },
  {
    ...
    image: '/products/strawberry-butter.jpg',
    tintColor: '#FB7185',
  ...
  },
  {
    ...
    image: '/products/unicorn-crunch.jpg',
    tintColor: '#F472B6',
  ...
  },
  {
    ...
    image: '/products/tropical-sunset.jpg',
    tintColor: '#FB923C',
  ...
  },
  {
    ...
    image: '/products/mint-chocolate.jpg',
    tintColor: '#34D399',
  ...
  },
  {
    ...
    image: '/products/rainbow-explosion.jpg',
    tintColor: '#F59E0B',
  ...
  },
  {
    ...
    image: '/products/peach-paradise.jpg',
    tintColor: '#FDBA74',
  ...
  {
    id: 'mystery-mini',
    name: 'The "I Believe In You" Mini',
    category: 'clear',
    price: 4.99,
    description: 'For the aunt, uncle, grandma, or cousin who wants to support RJ but isn\'t quite ready to go full slime mode. You\'ll get a mystery mini slime in a hilariously random container. Could be a tiny jar. Could be a repurposed baby food container. Who knows? That\'s the fun.',
    scent: 'Mystery',
    texture: 'Dealer\'s Choice',
    image: '/products/rainbow-explosion.jpg',
    tintColor: '#F59E0B',
