...
export const products: Product[] = [
  ...
  {
    id: 'test-slime',
    name: 'Mini Slime Sample',
    category: 'clear',
    price: 1.00,
    description: 'Try a mini sample of our premium slime. Perfect for first-time slimers!',
    scent: 'Unscented',
    texture: 'Smooth & Stretchy',
    image: '/products/ocean-breeze.jpg',
    tintColor: '#6EE7B7',
    gradient: 'from-green-300 via-teal-300 to-cyan-300',
    inStock: true,
  },
  {
    id: 'lemon-drop',
